...
if __name__ == "__main__":
    ...
    os.makedirs("../../res/graficos/_test", exist_ok=True); x=np.linspace(0,2*np.pi,400)
    plt.plot(x, np.sin(x)); plt.savefig("../../res/graficos/_test/prueba.png", dpi=220, bbox_inches="tight"); plt.close()
