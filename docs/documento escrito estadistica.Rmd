...
Este panorama motiva la siguiente pregunta de investigación: ¿cómo se distribuye territorialmente la prevalencia de sobrepeso y obesidad infantil en Costa Rica, y con qué grado de incertidumbre podemos estimarla a partir de la evidencia disponible? Para responderla, en este estudio se adopta un enfoque bayesiano explícito en la cuantificación de la incertidumbre y se propone, primero, estimar la distribución posterior de la prevalencia de sobrepeso y de obesidad en cada provincia mediante un modelo binomial bayesiano y métodos computacionales de inferencia; cuando corresponda, se emplearán algoritmos de muestreo eficientes como NUTS/HMC para garantizar una exploración adecuada del espacio posterior [@HoffmanGelman2014]. En segundo lugar, se compararán los resultados entre provincias y cantones, analizando medias posteriores e intervalos de credibilidad, con el fin de evaluar la heterogeneidad territorial. Finalmente, visualizaremos la prevalencia estimada y su incertidumbre posterior mediante mapas y gráficos que faciliten la interpretación y comunicación de los hallazgos a audiencias técnicas y de política pública.
