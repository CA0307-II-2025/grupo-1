...
Dada la naturaleza de los datos, la verosimilitud utilizada es una Binomial(total, p), y la previa a utilizar es Beta(1, 1). Con ello, se estima el p, es decir, la probabilidad de pertenecer a la categoría de obesidad o de sobrepeso, independientemente del cantón al que se pertenece. Así, se estima la prevalencia de obesidad y sobrepeso en Costa Rica.
Al hacer esto, se obtienen los siguientes resultados:
### Autocorrelación
Para el método de Metropolis-Hasting, en ambos casos, se obtuvo una alta correlación entre cada elemento de la cadena.
![](../res/graficos/autocorr_obesidad.png)
![](../res/graficos/autocorr_sobrepeso.png)
### Histogramas
...
![](../res/graficos/hist_post_obesidad.png)
![](../res/graficos/hist_post_sobrepeso.png)
