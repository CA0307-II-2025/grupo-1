...
# Resumen
Este estudio analiza la prevalencia de sobrepeso y obesidad infantil en Costa Rica mediante un enfoque bayesiano aplicado a los datos del Primer Censo Escolar de Peso/Talla 2016 para niños de 6 a 12 años. Se modelan los conteos de casos por cantón con una verosimilitud binomial y enlace logit, incorporando covariables socioeconómicas y demográficas estandarizadas (urbanización, privación, escolaridad, estructura de los hogares, entre otras). Las priors normales débiles sobre los coeficientes y la selección previa de covariables basada en el criterio de información de Akaike permiten evitar modelos sobreajustados. La inferencia se realiza mediante el algoritmo No-U-Turn Sampler (NUTS), una variante de Hamiltonian Monte Carlo que adapta automáticamente el tamaño y la longitud de las trayectorias, generando muestras posteriores bien mezcladas para las probabilidades de prevalencia por unidad territorial. A partir de estas muestras se obtienen estimaciones puntuales (medias posteriores) e intervalos de credibilidad del 95 % a nivel nacional, provincial y cantonal. Los resultados indican una prevalencia nacional posterior de 14 % para obesidad y 20 % para sobrepeso, con un exceso de peso combinado cercano al 34 %. Se observa un gradiente centro–periferia: las provincias y cantones del Valle Central concentran las prevalencias más altas, mientras que provincias costeras y cantones periféricos presentan valores sistemáticamente menores. Estos patrones son consistentes con la evidencia regional sobre la concentración del exceso de peso en territorios más urbanizados y de mayor desarrollo económico. En conjunto, los hallazgos confirman que el sobrepeso y la obesidad infantil constituyen un problema estructural de salud pública en Costa Rica y muestran que los métodos bayesianos logit–binomiales son una herramienta útil para cuantificar la prevalencia y su incertidumbre a distintos niveles geográficos, aportando insumos para el diseño y la focalización de políticas públicas.
