...
$p_i$: es la probabilidad (prevalencia) de la condición en la fila $i$, es decir, la probabilidad de que una persona seleccionada al azar en el distrito $i$ presente la condición, dada la infromación sociodemográfica capturada el vector de covariables. Es la cantidad central del modelo: determina la distribución binomial $y_i\mid p_i\sim\mathrm{Binomial}(n_i,p_i)$ y a partir de sus muestras posteriores se obtienen medias, intervalos de credibilidad e indicadores agregados (por provincia o país).
