...
- [$\checkmark$] Tenemos resultados preliminares, falta plasmarlos en el documento escrito.
- [$\checkmark$] Se analizaron los datos.
- [$\checkmark$] Se investigan posibles metodologías.
- [$\checkmark$] Se realizan resultados preliminares.
...
- **Profesor**: Optimizar el AIC y BIC para la elección de variables a utilizar. Además, desea que se implemente el modelo a nivel cantonal.
- **Compañeros:** Nos falta completar la metodología, con el fundamento teórico de los métodos utilizados.


## ✔️  Criterios de aceptación cumplidos:
- [$\checkmark$] Se especifica el modelo seleccionado en el documento final
- [$\checkmark$] Se obtuvieron estimaciones reproducibles
- [$\checkmark$] Los resultados se encuentran en el documento final
